        ...
        {isSidebarVisible && (
          ...
          >
            <div className="flex justify-between items-center p-6 border-b border-orange-100">
              ...
              <button
                className="text-gray-300 hover:text-gray-300 text-2xl transition-colors hover:bg-gray-800 p-2 rounded-full"
              ...
              <SignedIn>
                <UserButton
                  appearance={{
                    elements: {
                      avatarBox:
                        "w-12 h-12 rounded-full border-2 border-orange-100 shadow-lg shadow-orange-200",
                    },
                  }}
                />
              </SignedIn>
